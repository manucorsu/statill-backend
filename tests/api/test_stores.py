...
def _random_store():
    ...
    Returns:
        dict[str, Any]: A JSON-formatted string containing randomly generated store data, including
            name, category, address, preorder_enabled, ps_max, ps_value, opening_times, closing_times and payement_methods.
    """
    ...
    return {
        ...
        "ps_max": random.choice((None, random.randint(1, 10000))),
